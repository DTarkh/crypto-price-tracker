...
export default function CoinTicker({ symbol }: CoinTickerProps) {
  ...
  if (!ticker) {
    return (
      <div className="w-[300px] h-[285px] mx-auto p-6 bg-[#0b201d] shadow-xl rounded-xl my-8 flex items-center justify-center">
        <ThreeCircles
          visible={true}
          height="40"
          width="40"
  ...
  return (
    <div className="w-[300px] h-[285px] mx-auto p-6 bg-[#0b201d] shadow-xl rounded-xl my-8">
