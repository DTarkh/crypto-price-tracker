...
export default function CoinTicker({ symbol }: CoinTickerProps) {
  ...
  if (!ticker) {
    return (
      <div className="w-[300px] h-[300px] mx-auto p-6 bg-white shadow-xl rounded-xl mt-8 flex items-center justify-center">
        <ThreeCircles
          visible={true}
          height="40"
          width="40"
  ...
  return (
    <div className="w-[300px] h-[300px] mx-auto p-6 bg-white shadow-xl rounded-xl mt-8">
